...
def start_(bot, message):
    ...
    START_BUTTON = [
                [
                    InlineKeyboardButton(text="💥ᴀᴅᴅ ᴄʀᴏᴡ ᴀᴘɴᴇ ɢʀᴏᴜᴘs ᴘʀ", url="http://t.me/Shinemusicbot?startgroup=true"),
                ],
                [
...
def callback_query(Client, callback: CallbackQuery):
    if callback.data == "help_":
        ...
        HELP_TXT = f"""Hoi, Here is the help menu choose your desireoption nd explorer it!!\nFor any kind of help or query Just join @SHINEVCBOT_SUPPORT and ask your query!!"""
        ...
        REPO_MSG = f"""Hey, Here is the source code of SHINEXVCBOT🧚‍♀️\nSo deploy your own!!"""
        REPO_BUTTONS = [
            [
        ...
        START_TEXT = f"""Hey, Myself SHINE X VC BOT!\nA simple , lagfree and flexible music robot!\nIf you facing any issue related to this music bot then please join @SilentVerse\nFor more help you can explorer help menu by tapping on /help !"""
        START_BUTTON = [
                    [
                        InlineKeyboardButton(text="ShineMusic", url="http://t.me/Shinevcbot?startgroup=true"),
                    ],
                    [
                        InlineKeyboardButton(text="Updates", url="https://t.me/ShineVcupdates"),
                        InlineKeyboardButton(text="Source✨", callback_data="repo_k"),
